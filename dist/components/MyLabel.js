...
var MyLabel = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("span", __assign({ style: { color: fontColor }, className: "label ".concat(size, " text-").concat(color) }, { children: allCaps ? label.toLocaleUpperCase() : label })));
};
